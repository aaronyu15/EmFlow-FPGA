...
################################################################
# This is a generated script based on design: kv260
#
...
prophesee.ai:ip:axis_tkeep_handler:2.0\
xilinx.com:ip:clk_wiz:6.0\
prophesee.ai:ip:event_stream_smart_tracker:2.0\
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {9} $axi_interconnect_master_lpd


  # Create instance: axis_tkeep_handler_0, and set properties
  set axis_tkeep_handler_0 [ create_bd_cell -type ip -vlnv prophesee.ai:ip:axis_tkeep_handler:2.0 axis_tkeep_handler_0 ]
  ...
  set event_stream_smart_t_0 [ create_bd_cell -type ip -vlnv prophesee.ai:ip:event_stream_smart_tracker:2.0 event_stream_smart_t_0 ]
  set_property CONFIG.SMART_DROP_FIFO_DEPTH_G {64} $event_stream_smart_t_0


  # Create instance: flow_wrapper_0, and set properties
  set block_name flow_wrapper
  set block_cell_name flow_wrapper_0
  if { [catch {set flow_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $flow_wrapper_0 eq "" } {
  ...
  set_property -dict [list \
    CONFIG.Coe_File {/home/aaron/Research_Projs/kria/build/projects/kv260/kv260.srcs/sources_1/imports/kv260/coe/kv260_system_register.coe} \
...
\
  ...
  connect_bd_intf_net -intf_net axi_interconnect_master_lpd_M03_AXI [get_bd_intf_pins axi_interconnect_master_lpd/M03_AXI] [get_bd_intf_pins flow_wrapper_0/s_axi]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_master_lpd_M08_AXI [get_bd_intf_pins axi_gpio_1/S_AXI] [get_bd_intf_pins axi_interconnect_master_lpd/M08_AXI]
  connect_bd_intf_net -intf_net axis_tkeep_handler_0_m_axis [get_bd_intf_pins axis_tkeep_handler_0/m_axis] [get_bd_intf_pins event_stream_smart_t_0/s_axis]
  ...
  connect_bd_intf_net -intf_net event_stream_smart_t_0_m_axis [get_bd_intf_pins event_stream_smart_t_0/m_axis] [get_bd_intf_pins flow_wrapper_0/s_axis]
  connect_bd_intf_net -intf_net flow_wrapper_0_m_axis [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins flow_wrapper_0/m_axis]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_processing_system/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_processing_system/Data] [get_bd_addr_segs event_stream_smart_t_0/s_axi/Reg] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_processing_system/Data] [get_bd_addr_segs flow_wrapper_0/s_axi/reg0] -force
